...
class ConstantColor{
  static Color darkModeColor = Color(0xffE1E1E1);
  static Color darkThemeDarkShadowColor = Color(0xff101112);
  static Color darkNeumorphicShadowColor = Color(0xff202427);
  ...
  static Color lightTextBodyColor = Color(0xff7b7b7b);
  static Color lightIconColor = Color(0xff7b7b7b);
}